...
public class EmailNotificationProvider implements NotificationProvider {
    ...
    public void sendNotification(Notification notification) {
        ...
        final EmailFormat emailFormat1 = (EmailFormat) messageFormatRepository.getMessageFormat(notification.getType(), notification.getChannel());
        thirdPartyEmailSender.sendEmail(emailFormat.getBody(), emailFormat.getSubject(), notification.getTo().getEmail(), null, null);
    }
